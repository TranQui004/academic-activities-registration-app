...
import 'package:doan/views/capnhatsukien.dart';
...
class _EventListBodyState extends State<EventListBody> {
  ...
  @override
  Widget build(BuildContext context) {
    final sv = Provider.of<DoanKhoaProvider>(context).doanKhoa!;
    return Column(
      children: [
        // Thanh tìm kiếm
        EventListSearchBar(
                ...
                children: [
                  ...
                  Material(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => CapNhatSuKien(event: event),
                            ));
                      },
                      borderRadius: BorderRadius.circular(8),
                      child: Padding(
                      ...
                      onTap: () async {
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            title: Text('Thông báo xoá sự kiện'),
                            content: Text('Bạn có chắc chắn muốn xoá ${event.TenSuKien} không?'),
                            actions: [
                              TextButton(
                              ...
                              TextButton(
                                onPressed: () async {
                                  await CloudService().deleteEvent(event.id);
                                  Navigator.pop(context);
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context) => DSSinhVienThamGia(idSK: event,),
                  ));
                },
