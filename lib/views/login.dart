                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(), labelText: 'Nhập mã sinh viên',
                                  filled: true,
                            ...
                            SizedBox(height: 24,),
                            Padding(padding: EdgeInsets.only(right: 12, left: 12),
                              child: Row(
            ...
            child: Padding(padding: EdgeInsets.all(24),
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12,),
                  Text('Đồ án môn học: Ứng dụng đăng ký hoạt động Seminar, đoàn đội.',
                    style: TextStyle(
                      color: AppColors.textWhite,
                      fontSize: 16
                    ),
